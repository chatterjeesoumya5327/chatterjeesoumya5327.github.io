...
const commandResponses = {
    'help': R([
        ...
        { type: 'response', html: '<span class="t-yellow">soumya --awards</span>        <span class="t-muted">Awards & recognition</span>' },
    ]),
    'whoami': R([
    ...
    'soumya --awards': R([
        { type: 'info',     html: '<span class="t-cyan t-bold">Awards &amp; Recognition</span>' },
        { type: 'response', html: '<span class="t-green">Impact Awards 2025          </span>JPMorgan Chase &amp; Co.     Apr 2026' },
        { type: 'response', html: '<span class="t-muted">  Presented by CEO, Corporate Centers, India &amp; Philippines for Client Centricity.</span>' },
        { type: 'divider',  html: '' },
        { type: 'response', html: '<span class="t-green">Champions Award             </span>Accenture                 May 2021' },
        { type: 'response', html: '<span class="t-muted">  Issued by Accenture Project Delivery Lead.</span>' },
        { type: 'divider',  html: '' },
        { type: 'response', html: '<span class="t-green">Champions Award             </span>Accenture                 May 2020' },
        { type: 'response', html: '<span class="t-muted">  Issued by Accenture Project Delivery Lead.</span>' },
        { type: 'divider',  html: '' },
        { type: 'response', html: '<span class="t-green">Certificate of Appreciation </span>Tata Consultancy Services Oct 2017' },
        { type: 'response', html: '<span class="t-muted">  Issued by Client\'s VP, Customer Innovation Technology, for outstanding work delivered.</span>' },
        { type: 'divider',  html: '' },
        { type: 'response', html: '<span class="t-green">Certificate of Excellence   </span>Tata Consultancy Services Jul 2016' },
        { type: 'response', html: '<span class="t-muted">  Issued by Client\'s Delivery Head in appreciation of outstanding contribution.</span>' },
    ]),
    'soumya --academics': R([
